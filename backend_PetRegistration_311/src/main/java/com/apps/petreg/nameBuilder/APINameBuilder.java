...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "VeterinaryDoctor".equals(entityTypeName) ? "VeterinaryDoctors" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	eSetName = "Vaccine".equals(entityTypeName) ? "Vaccines" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	eSetName = "PetVisit".equals(entityTypeName) ? "PetVisits" : defaultNameBuilder.buildEntitySetName(entityTypeName);
